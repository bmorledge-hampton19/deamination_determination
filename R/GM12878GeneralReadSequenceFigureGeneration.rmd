...
for (i in seq_along(CPDTGGSeqFreq)) {
  plotSequenceFrequencies(CPDTGGSeqFreq[[i]], title = paste("Cisplatin TGG Frequencies", repNames[i]),
                          expansionOffset = expansionOffset, showThreePrimeCutSite = TRUE,
                          showFivePrimeCutSite = TRUE, querySequences = c("TGG"))
}

for (i in seq_along(CPDCGASeqFreq)) {
  plotSequenceFrequencies(CPDCGASeqFreq[[i]], title = paste("Cisplatin CGA Frequencies", repNames[i]),
                          expansionOffset = expansionOffset, showThreePrimeCutSite = TRUE,
