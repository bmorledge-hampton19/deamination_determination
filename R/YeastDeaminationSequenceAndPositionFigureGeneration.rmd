...
for (i in seq_along(CPDMismatchData)) {
  plotPositionAcrossTimepointAndReadLength(CPDMismatchData[[i]]["20min"], includedTypes = c("C>T"),
                                           title = paste(c("CPD", titleCaseFiltering,
                                                           "C>T Mismatch Pos Freq", repNames[i]), collapse = ' '),
                                           zScoreTables = CPDMMFreqZScores[[i]])
  plotPositionAcrossTimepointAndReadLength(CPDMismatchData[[i]]["20min"], includedTypes = c("C>T"),
...
for (i in seq_along(sixFourMismatchData)) {
  plotPositionAcrossTimepointAndReadLength(sixFourMismatchData[[i]], includedTypes = c("C>T"),
                                           title = paste(c("6-4", titleCaseFiltering,
                                                           "C>T Mismatch Pos Freq", repNames[i]), collapse = ' '),
                                           zScoreTables = sixFourMMFreqZScores[[i]])
  plotPositionAcrossTimepointAndReadLength(sixFourMismatchData[[i]], includedTypes = c("C>T"), posType = FIVE_PRIME,
                                           title = paste(c("6-4", titleCaseFiltering,
                                                           "C>T Mismatch Pos Freq", repNames[i]), collapse = ' '),
                                           zScoreTables = sixFourMMFreqZScores[[i]])
}
...
for (i in seq_along(CPDGroupedStats)) {
  plotGroupedPositionStats(CPDGroupedStats[[i]]$three_prime[Timepoint == "20min"],
                           CPDGroupedStats[[i]]$five_prime[Timepoint == "20min"],
