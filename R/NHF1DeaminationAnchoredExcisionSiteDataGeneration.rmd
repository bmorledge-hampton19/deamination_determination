...
sixFourMismatchData = mapply(function(sixFourMismatchDataRep, sixFourMMFreqZScoreRep) mapply(
  filterMismatchesByPositionAndReadLength, sixFourMismatchDataRep, sixFourMMFreqZScoreRep,
  expansionOffset = expansionOffset, SIMPLIFY = FALSE
), sixFourMismatchData, sixFourMMFreqZScores, SIMPLIFY = FALSE)
```
