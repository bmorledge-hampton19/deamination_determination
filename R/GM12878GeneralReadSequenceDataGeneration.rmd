---
title: "GM12878 General Read Sequence Data Generation"
...
```{r compute_and_write_cisplatin_sequence_frequency}
for (repitition in c("rep1", "rep2")) {
  for (timepoint in names(CisplatinTimepoints)) {
    singleFileFullAnalysis("cisplatin", repitition, timepoint)
  }
}
```
