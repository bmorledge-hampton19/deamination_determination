...
for (i in seq_along(CPDTGGSeqFreq)) {
  plotSequenceFrequencies(CPDTGGSeqFreq[[i]],
                          title = "CPD TGG Frequencies", repNames[i], expansionOffset = expansionOffset,
...
for (i in seq_along(CPDCGASeqFreq)) {
  plotSequenceFrequencies(CPDCGASeqFreq[[i]],
                          title = "CPD CGA Frequencies", repNames[i], expansionOffset = expansionOffset,
                          showThreePrimeCutSite = TRUE, showFivePrimeCutSite = TRUE,
...
for (i in seq_along(sixFourTGGSeqFreq)) {
  plotSequenceFrequencies(sixFourTGGSeqFreq[[i]],
                          title = "6-4 TGG Frequencies", repNames[i], expansionOffset = expansionOffset,
                          showThreePrimeCutSite = TRUE, showFivePrimeCutSite = TRUE,
                          querySequences = c("TGG"))
}

for (i in seq_along(sixFourCGASeqFreq)) {
  plotSequenceFrequencies(sixFourCGASeqFreq[[i]],
                          title = "6-4 CGA Frequencies", repNames[i], expansionOffset = expansionOffset,
                          showThreePrimeCutSite = TRUE, showFivePrimeCutSite = TRUE,
                          querySequences = c("CGA"))
}
```
