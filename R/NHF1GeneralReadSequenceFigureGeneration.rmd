...
readAndPlotReadLengthFrequencies = function(lesion, repitition, timepoints) {
  ...
  for (i in seq_along(readData)) {
    ...
    readData[[i]] = readData[[i]][Read_Length >= 20 & Read_Length <= 31]
  }
...
plotReadLengthFrequencies("6-4", "rep1", sixFourTimepoints)
plotReadLengthFrequencies("6-4", "rep2", sixFourTimepoints)
```
