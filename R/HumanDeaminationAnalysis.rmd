...
CPDMismatchDataFilePaths$rep1 = list(
  hr1 = file.path(deaminationDataDirectory, "NHF1_CPD_1h_Rep1_mismatches_by_read.bed"),
  hr8 = file.path(deaminationDataDirectory, "NHF1_CPD_8h_Rep1_mismatches_by_read.bed"),
  hr24 = file.path(deaminationDataDirectory, "NHF1_CPD_24h_Rep1_mismatches_by_read.bed"),
  hr48 = file.path(deaminationDataDirectory, "NHF1_CPD_48h_Rep1_mismatches_by_read.bed")
)
CPDMismatchDataFilePaths$rep2 = list(
  hr1 = file.path(deaminationDataDirectory, "NHF1_CPD_1h_Rep2_mismatches_by_read.bed"),
  hr8 = file.path(deaminationDataDirectory, "NHF1_CPD_8h_Rep2_mismatches_by_read.bed"),
  hr24 = file.path(deaminationDataDirectory, "NHF1_CPD_24h_Rep2_mismatches_by_read.bed"),
  hr48 = file.path(deaminationDataDirectory, "NHF1_CPD_48h_Rep2_mismatches_by_read.bed")
)

sixFourMismatchDataFilePaths = list(rep1 = list(), rep2 = list())
sixFourMismatchDataFilePaths$rep1 = list(
  min5 = file.path(deaminationDataDirectory, "NHF1_6-4-PP_5min_Rep1_mismatches_by_read.bed"),
  min20 = file.path(deaminationDataDirectory, "NHF1_6-4-PP_20min_Rep1_mismatches_by_read.bed"),
  hr1 = file.path(deaminationDataDirectory, "NHF1_6-4-PP_1h_Rep1_mismatches_by_read.bed")
)
sixFourMismatchDataFilePaths$rep2 = list(
  min5 = file.path(deaminationDataDirectory, "NHF1_6-4-PP_5min_Rep2_mismatches_by_read.bed"),
  min20 = file.path(deaminationDataDirectory, "NHF1_6-4-PP_20min_Rep2_mismatches_by_read.bed"),
  hr1 = file.path(deaminationDataDirectory, "NHF1_6-4-PP_1h_Rep2_mismatches_by_read.bed")
)
...
plotNucFreqVsReadLengthBarPlot(CPDSingleCToTMismatchData$rep1, THREE_PRIME,
                               ...
                               combineNucleotides = c("AG","CG"), combinedNames = c("Purine","Pyrimidine"))
