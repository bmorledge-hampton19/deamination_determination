...
plotNucFreqVsReadLengthBarPlot(rbindlist(lapply(CPDSingleCToTMismatchData$rep1,
                               THREE_PRIME, title = "CPD Rep1 3' Nuc Freq",
                               combineNucleotides = c("AG","CG"), combinedNames = c("Purine","Pyrimidine"))
plotNucFreqVsReadLengthBarPlot(CPDSingleCToTMismatchData$rep2,
                               THREE_PRIME, title = "CPD Rep2 3' Nuc Freq",
                               combineNucleotides = c("AG","CG"), combinedNames = c("Purine","Pyrimidine"))
plotNucFreqVsReadLengthBarPlot(CPDSingleCToTMismatchData$rep1,
                               FIVE_PRIME, title = "CPD Rep1 5' Nuc Freq",
                               combineNucleotides = c("AG","CG"), combinedNames = c("Purine","Pyrimidine"))
plotNucFreqVsReadLengthBarPlot(CPDSingleCToTMismatchData$rep2,
                               FIVE_PRIME, title = "CPD Rep2 5' Nuc Freq",
                               combineNucleotides = c("AG","CG"), combinedNames = c("Purine","Pyrimidine"))
