---
title: "E coli WT Deamination Sequence and Position Data Generation"
...
CPDMMFreqZScores = lapply(CPDMismatchData, function(x) lapply(
  x, function(y) {
    getMismatchFrequencyZScoreByPosAndReadLength(y[Mismatch == "C>T"], expansionOffset, noisePositions = 5)
  }
))
