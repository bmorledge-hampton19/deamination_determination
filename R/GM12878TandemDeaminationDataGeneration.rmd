...
for (i in seq_along(cisplatinGroupedStats)) {
  cisplatinGroupedStats[[i]]$three_prime = getGroupedPositionStats(cisplatinMismatchData[[i]])
  cisplatinGroupedStats[[i]]$five_prime = getGroupedPositionStats(cisplatinMismatchData[[i]], posType = FIVE_PRIME)
}
