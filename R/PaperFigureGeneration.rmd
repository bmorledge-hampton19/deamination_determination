...
for (i in seq_along(NHF1PairedCutSiteDistances)) {
  NHF1PairedCutSiteDistances[[i]] = list(CC_to_TT = NULL, non_C_to_T = NULL)
...
arabidopsisShuffledCutSiteDistances = list(ZT2 = NULL)
...
arabidopsisShuffledCutSiteDistances$ZT2 = getShufflePairedCutSiteDistances(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT)
arabidopsisPairedCutSiteDistances$ZT2$non_C_to_T = fread(generateFilePath(
  arabidopsisCutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances , ".tsv",
  cellType = "Arabidopsis", lesion = "CPD", timepoint = "ZT2",
  repitition = "all_reps", filtering = "TGG_filtered",
  omittedMismatches = "C>T"
...
print(paste0("Coupling: ", getCouplingRate(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           ...
                           xlim = c(15,25.5), ylim = c(4,12.5))
```
```{r figure_7E, fig.width = 6, fig.height = 5}
print(paste0("Coupling: ", getCouplingRate(arabidopsisShuffledCutSiteDistances$ZT2)*-100, '%'))
plotPairedCutSiteDistances(arabidopsisShuffledCutSiteDistances$ZT2, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "Arabidopsis ZT2 CC>TT All Reps TGG-filtered Shuffled",
                           xlim = c(15,25.5), ylim = c(4,12.5))
```
```{r figure_7F, fig.width = 6, fig.height = 5}
print(paste0("Coupling: ", getCouplingRate(arabidopsisPairedCutSiteDistances$ZT2$non_C_to_T)*-100, '%'))
plotPairedCutSiteDistances(arabidopsisPairedCutSiteDistances$ZT2$non_C_to_T, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "Arabidopsis ZT2 Non-C>T All Reps TGG-filtered",
                           xlim = c(0,31), ylim = c(0,31))
```


```{r read_figure_8_data}
NHF1NucleosomeRelativeCutSiteDistances = NHF1CPDTimepoints
...
print(paste0("CC>TT Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`8h`$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 8h CC>TT All Reps TGG-filtered",
                           xlim = c(12,26), ylim = c(0,14.5),
                           xAxisBreaks = seq(12,26,2), yAxisBreaks = seq(0,14,2))
print(paste0("Shuffled CC>TT Coupling: ", getCouplingRate(NHF1ShuffledCutSiteDistances$`8h`)*-100, '%'))
plotPairedCutSiteDistances(NHF1ShuffledCutSiteDistances$`1h`, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 8h CC>TT All Reps TGG-filtered Shuffled",
                           xlim = c(12,26), ylim = c(0,14.5),
                           xAxisBreaks = seq(12,26,2), yAxisBreaks = seq(0,14,2))
print(paste0("Non-C>T Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`8h`$non_C_to_T)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$non_C_to_T, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 8h Non-C>T All Reps TGG-filtered",
                           xlim = c(0,31), ylim = c(0,31))
```
...
yeastShuffledCutSiteDistances = list(`20min` = NULL)
...
yeastShuffledCutSiteDistances$`20min` = getShufflePairedCutSiteDistances(yeastPairedCutSiteDistances$`20min`$CC_to_TT)
yeastPairedCutSiteDistances$`20min`$non_C_to_T = fread(generateFilePath(
  yeastCutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances, ".tsv",
  cellType = "yeast", lesion = "CPD", timepoint = "20min",
  repitition = "all_reps", filtering = "TGG_filtered",
  omittedMismatches = "C>T"
...
print(paste0("CC>TT Coupling: ", getCouplingRate(yeastPairedCutSiteDistances$`20min`$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(yeastPairedCutSiteDistances$`20min`$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           ...
                           xlim = c(11,19.5), ylim = c(5,14), yAxisBreaks = c(5,7,9,11,13))
print(paste0("Shuffled CC>TT Coupling: ", getCouplingRate(yeastShuffledCutSiteDistances$`20min`)*-100, '%'))
plotPairedCutSiteDistances(yeastShuffledCutSiteDistances$`20min`, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "Yeast 20min CC>TT All Reps TGG-filtered Shuffled",
                           xlim = c(11,19.5), ylim = c(5,14), yAxisBreaks = c(5,7,9,11,13))
print(paste0("Non-C>T Coupling: ", getCouplingRate(yeastPairedCutSiteDistances$`20min`$non_C_to_T)*-100, '%'))
plotPairedCutSiteDistances(yeastPairedCutSiteDistances$`20min`$non_C_to_T, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "Yeast 20min Non-C>T All Reps TGG-filtered",
