...
NHF1GeneralReadsCPDSeqFreqAllReps1hFiltered = fread(generateFilePath(
...
arabidopsisGeneralReadsCPDSeqFreqAllRepsZT2Filtered = fread(generateFilePath(
...
yeastGeneralReadsCPDSeqFreqAllReps20MinFiltered = fread(generateFilePath(
  yeastGeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
  cellType = "yeast", lesion = "CPD", timepoint = "20min",
  repitition = "all_reps", sequence = "HYV", filtering = "TGG_filtered"
))
EColiGeneralReadsCPDSeqFreqAllReps5MinFiltered = fread(generateFilePath(
...
```
```{r figure_4C, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(NHF1GeneralReadsCPDSeqFreqAllReps1hFiltered[Position <= 7],
                        ...
                        xAxisBreaks = c(-8, 0, 8))
```
```{r figure_4D, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(arabidopsisGeneralReadsCPDSeqFreqAllRepsZT2Filtered[Position <= 7],
                        title = "Arabidopsis CPD ZT2 All Reps TGG-Filtered General Reads HYV Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "HYV Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("333"), xAxisOffset = 1,
                        expansionOffset = 10, minReadLength = 24, maxReadLength = 30, backgroundPositions = -9:-4,
                        checkPositions = -1, displayPValue = FALSE, xAxisLabel = "5' Relative Position",
                        xAxisBreaks = c(-8, 0, 8))
```
```{r figure_4E, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(yeastGeneralReadsCPDSeqFreqAllReps20MinFiltered[Position <= 7],
                        title = "Yeast CPD 20min All Reps TGG-Filtered General Reads HYV Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "HYV Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("333"), xAxisOffset = 1,
                        expansionOffset = 10, minReadLength = 22, maxReadLength = 25, backgroundPositions = -9:-4,
                        checkPositions = -1, displayPValue = FALSE, xAxisLabel = "5' Relative Position",
                        xAxisBreaks = c(-8, 0, 8))
```
```{r figure_4F, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(EColiGeneralReadsCPDSeqFreqAllReps5MinFiltered[Position <= 7],
                        title = "E. coli CPD 5min All Reps TGG-Filtered General Reads HYV Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "HYV Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("333"), xAxisOffset = 1,
                        expansionOffset = 10, minReadLength = 11, maxReadLength = 13, xAxisLabel = "5' Relative Position",
                        xAxisBreaks = c(-8, 0, 8))
```
...
NHF1GeneralReadsSixFourSeqFreqAllReps20minFiltered = fread(generateFilePath(
  NHF1GeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
  cellType = "NHF1", lesion = "6-4", timepoint = "20min",
  repitition = "all_reps", sequence = "HYV", filtering = "TGG_filtered"
))
GM12878GeneralReadsCisplatinSeqFreqRep1_90minFiltered = fread(generateFilePath(
...
```{r figure_S4, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(NHF1GeneralReadsSixFourSeqFreqAllReps20minFiltered[Position <= 7],
                        ...
                        checkPositions = -1, displayPValue = FALSE, xAxisLabel = "5' Relative Position",
                        xAxisOffset = 1)
plotSequenceFrequencies(GM12878GeneralReadsCisplatinSeqFreqRep1_90minFiltered[Position <= 7],
...
```{r figure_S5, fig.width = 9, fig.height = 5}
