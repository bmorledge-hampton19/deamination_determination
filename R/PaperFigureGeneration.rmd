...
plotPositionAcrossTimepointAndReadLength(yeastCPDMismatchDataAllRepsFiltered["20min"], includedTypes = c("C>T"),
                                         ...
                                         xAxisBreaks = c(1,10,20,30))
```
```{r figure_S8C, fig.width = 7.5, fig.height = 5}
...
```{r figure_S9, fig.width = 5, fig.height = 4}
...
```{r figure_S10, fig.width = 6.5, fig.height = 6}
...
```{r figure_S11, fig.width = 5, fig.height = 5.5}
