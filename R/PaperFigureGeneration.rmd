...
NHF1FeatureRelativeDataDirectory = file.path(deaminationDataDirectory, "NHF1", "feature_relative_analysis")
...
CSBGeneralReadSequenceDataDirectory = file.path(CSBDataDirectory, "general_read_sequences")
...
XPCGeneralReadSequenceDataDirectory = file.path(XPCDataDirectory, "general_read_sequences")
...
plotMismatchPositionFrequencies(NHF1CPDMismatchDataAllReps$`1h`, includedTypes = c("C>T"),
                                ...
                                xAxisBreaks = c(-1,-10,-20,-30), ylim = c(0,0.25))
```
...
plotPositionAcrossTimepointAndReadLength(arabidopsisCPDMismatchDataAllRepsFiltered["ZT2"], includedTypes = c("C>T"),
                                         ...
                                         yAxisLabel = "Relative C>T Frequency", xAxisBreaks = c(-1,-10,-20,-30))
```
```{r figure_3C, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(NHF1CPDMismatchDataAllRepsTGGFiltered["1h"], includedTypes = c("C>T"),
                                         title = "NHF1 CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = NHF1CPDMMFreqZScoresAllRepsTGGFiltered,
                                         ...
                                         xAxisBreaks = c(1,10,20,30))
```
```{r figure_3D, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(arabidopsisCPDMismatchDataAllRepsFiltered["ZT2"], includedTypes = c("C>T"),
                                         title = "Arabidopsis CPD ZT2 All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = arabidopsisCPDMMFreqZScoresAllRepsFiltered,
                                         posType = FIVE_PRIME, yAxisLabel = "Relative C>T Frequency",
                                         xAxisBreaks = c(1,10,20,30))
```
```{r figure_3E, fig.width = 7.5, fig.height = 5}
plotGroupedPositionStats(NHF1CPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                         ...
                         xAxisBreaks = c(22:30), ylim = c(0,5))
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(NHF1CPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   NHF1CPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(NHF1CPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   NHF1CPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"])))
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(NHF1CPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   NHF1CPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                                   mismatchData = NHF1CPDMismatchDataAllRepsTGGFiltered$`1h`)))
```
```{r figure_3F, fig.width = 7.5, fig.height = 5}
plotGroupedPositionStats(arabidopsisCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
                         ...
                         xAxisBreaks = c(24:30), ylim = c(0,5))
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(arabidopsisCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
                                   arabidopsisCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "ZT2"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(arabidopsisCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
...
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(arabidopsisCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
                                   arabidopsisCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "ZT2"],
                                   mismatchData = arabidopsisCPDMismatchDataAllRepsFiltered$ZT2)))
```
...
plotSequenceFrequencies(NHF1ThreePrimeMMAnchoredCPDSeqFreqAllRepsFiltered$`1h`,
                        ...
                        showFivePrimeCutSite = TRUE, querySequences = c("333"), xAxisOffset = 1, positionOffset = 1,
                        expansionOffset = 10, minReadLength = 19, maxReadLength = 25, endBasedBackgroundNum = 6,
...
arabidopsisCPDCCtoTTMismatchDataAllRepsFiltered = arabidopsisCPDTimepoints
for (i in seq_along(arabidopsisCPDCCtoTTMismatchDataAllRepsFiltered)) {
  arabidopsisCPDCCtoTTMismatchDataAllRepsFiltered[[i]] = fread(generateFilePath(
    arabidopsisSequenceAndPositionDataDirectory, dataTypeStrings$simplifiedMismatches, ".tsv",
    cellType = "Arabidopsis", lesion = "CPD", repitition = "all_reps",
    filtering = "TGG_filtered", includedMismatches = "CC>TT",
    timepoint = names(arabidopsisCPDCCtoTTMismatchDataAllRepsFiltered)[i]
  ))
}
...
yeastCPDCCtoTTMismatchDataAllRepsFiltered = yeastCPDTimepoints
for (i in seq_along(yeastCPDCCtoTTMismatchDataAllRepsFiltered)) {
  yeastCPDCCtoTTMismatchDataAllRepsFiltered[[i]] = fread(generateFilePath(
    yeastSequenceAndPositionDataDirectory, dataTypeStrings$simplifiedMismatches, ".tsv",
    cellType = "yeast", lesion = "CPD", repitition = "all_reps",
    filtering = "TGG_filtered", includedMismatches = "CC>TT",
    timepoint = names(yeastCPDCCtoTTMismatchDataAllRepsFiltered)[i]
  ))
}
...
```
```{r figure_6B, fig.width = 5, fig.height = 5.5}
### Just the 1h timepoint ###
plotPositionAcrossTimepointAndReadLength(NHF1CPDCCtoTTMismatchDataAllRepsFiltered["1h"], posType = FIVE_PRIME,
                                         title = "NHF1 CPD 1h All Reps TGG-Filtered CC>TT Mismatch Pos Freq",
                                         zScoreTables = NHF1CPDCCtoTTMMFreqZScoresAllRepsFiltered,
                                         yAxisLabel = "Relative CC>TT Frequency", xAxisBreaks = c(1,10,20,30))
...
#                                          yAxisLabel = "Relative CC>TT Frequency")
```
```{r figure_6C, fig.width = 5, fig.height = 5}
plotSequenceFrequencies(NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllReps1hFiltered,
                        ...
                        secondaryYAxisLabel = "5' Cut Site Distance", yAxisLabel = "HYV Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("333"),
                        expansionOffset = 10, minReadLength = 19.5, maxReadLength = 24.5, endBasedBackgroundNum = 6,
                        endBasedCheckPositions = -9, displayPValue = FALSE, xAxisLabel = "Mismatch Relative Position",
                        xAxisOffset = 1, positionOffset = 0.5, readLengthOffset = 0.5,
                        xAxisBreaks = c(-2,-10,-20,-30), xlim = c(-35,-3.5))
```
...
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(NHF1CPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   NHF1CPDCCToTTGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(NHF1CPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
...
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(NHF1CPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   NHF1CPDCCToTTGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                                   mismatchData = NHF1CPDCCtoTTMismatchDataAllRepsFiltered$`1h`)))
```
...
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(arabidopsisCPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
                                   arabidopsisCPDCCToTTGroupedStatsAllRepsFiltered$five_prime[Timepoint == "ZT2"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(arabidopsisCPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
...
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(arabidopsisCPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "ZT2"],
                                   arabidopsisCPDCCToTTGroupedStatsAllRepsFiltered$five_prime[Timepoint == "ZT2"],
                                   mismatchData = arabidopsisCPDCCtoTTMismatchDataAllRepsFiltered$ZT2)))
```
```{r figure_6F, fig.width = 7.5, fig.height = 5}
...
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(yeastCPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
                                   yeastCPDCCToTTGroupedStatsAllRepsFiltered$five_prime[Timepoint == "20min"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(yeastCPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
...
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(yeastCPDCCToTTGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
                                   yeastCPDCCToTTGroupedStatsAllRepsFiltered$five_prime[Timepoint == "20min"],
                                   mismatchData = yeastCPDCCtoTTMismatchDataAllRepsFiltered$`20min`)))
```


```{r read_figure_7_data}
set.seed(8785)
NHF1PairedCutSiteDistances = list(`1h` = NULL, `8h` = NULL)
NHF1ShuffledCutSiteDistances = list(`1h` = NULL, `8h` = NULL)
for (i in seq_along(NHF1PairedCutSiteDistances)) {
  NHF1PairedCutSiteDistances[[i]] = list(CC_to_TT = NULL, C_to_T = NULL, Non_C_to_T_Position_Filtered = NULL)
  NHF1PairedCutSiteDistances[[i]]$CC_to_TT = fread(generateFilePath(
    NHF1CutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances , ".tsv",
    cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1PairedCutSiteDistances)[i],
    repitition = "all_reps", filtering = "TGG_filtered",
    includedMismatches = "CC>TT"
  ))
  NHF1ShuffledCutSiteDistances[[i]] = getShufflePairedCutSiteDistances(NHF1PairedCutSiteDistances[[i]]$CC_to_TT)

  NHF1PairedCutSiteDistances[[i]]$C_to_T = fread(generateFilePath(
    NHF1CutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances , ".tsv",
    cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1PairedCutSiteDistances)[i],
    repitition = "all_reps", filtering = "TGG_filtered",
...
NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered = fread(generateFilePath(
  NHF1CutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances , ".tsv",
  cellType = "NHF1", lesion = "CPD", timepoint = "1h",
  repitition = "all_reps", filtering = "TGG_filtered",
  omittedMismatches = "C>T", additionalInformation = "atypical_position_filtering"
))

```


```{r figure_7A, fig.width = 6, fig.height = 5}
print(paste0("Read Length Slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`1h`$CC_to_TT)))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$CC_to_TT, READ_LENGTH,
                           title = "NHF1 1h CC>TT All Reps TGG-filtered",
                           xlim = c(12, 26), ylim = c(18.5, 32.5), xAxisBreaks = seq(13,25,3))
```
```{r figure_7B, fig.width = 6, fig.height = 5}
print(paste0("Read Length SLope: ", getReadLengthSlope(NHF1ShuffledCutSiteDistances$`1h`)))
plotPairedCutSiteDistances(NHF1ShuffledCutSiteDistances$`1h`, READ_LENGTH,
                           title = "NHF1 1h CC>TT All Reps TGG-filtered Shuffled",
                           xlim = c(6,30), ylim = c(13,37))
```
```{r figure_7C, fig.width = 6, fig.height = 5}
print(paste0("Read Length Slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered)))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered, READ_LENGTH,
                           title = "NHF1 1h Non-C>T Position-Filtered All Reps TGG-filtered",
                           xlim = c(10.5, 26.5), ylim = c(17.5, 33.5),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(18,33,3))
```
```{r figure_7D, fig.width = 6, fig.height = 5}
print(paste0("Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`1h`$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 1h CC>TT All Reps TGG-filtered",
                           xlim = c(12,26), ylim = c(0,14.5),
                           xAxisBreaks = seq(12,26,2), yAxisBreaks = seq(0,14,2))
```
```{r figure_7E, fig.width = 6, fig.height = 5}
print(paste0("Coupling: ", getCouplingRate(NHF1ShuffledCutSiteDistances$`1h`)*-100, '%'))
plotPairedCutSiteDistances(NHF1ShuffledCutSiteDistances$`1h`, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 1h CC>TT All Reps TGG-filtered Shuffled",
                           xlim = c(12,26), ylim = c(0,14.5),
                           xAxisBreaks = seq(12,26,2), yAxisBreaks = seq(0,14,2))
```
```{r figure_7F, fig.width = 6, fig.height = 5}
print(paste0("Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 1h Non-C>T Position-Filtered All Reps TGG-filtered",
                           xlim = c(10.5,26.5), ylim = c(0,16),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(0,15,3))
```

```{r read_figure_8_data}
NHF1NucleosomeRelativeCutSiteDistances = list(hg19_LCL_mnase_all_mappable = NULL)
for (j in seq_along(NHF1NucleosomeRelativeCutSiteDistances)) {
  NHF1NucleosomeRelativeCutSiteDistances[[j]] = list(`1h` = NULL, `8h` = NULL)
  for (i in seq_along(NHF1NucleosomeRelativeCutSiteDistances[[j]])) {
    NHF1NucleosomeRelativeCutSiteDistances[[j]][[i]] = list(three_prime = NULL, five_prime = NULL)
    NHF1NucleosomeRelativeCutSiteDistances[[j]][[i]]$three_prime = fread(generateFilePath(
      NHF1FeatureRelativeDataDirectory, dataTypeStrings$featureRelativeMeanCutSiteDistance, ".tsv",
      cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1NucleosomeRelativeCutSiteDistances[[j]])[i],
      strandPolarity = THREE_PRIME, repitition = "all_reps", filtering = "TGG_filtered",
      includedMismatches = "C>T", additionalInformation = paste0(names(NHF1NucleosomeRelativeCutSiteDistances)[j],
                                                                 "_related_strand_aligned")
    ))
    NHF1NucleosomeRelativeCutSiteDistances[[j]][[i]]$five_prime = fread(generateFilePath(
      NHF1FeatureRelativeDataDirectory, dataTypeStrings$featureRelativeMeanCutSiteDistance, ".tsv",
      cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1NucleosomeRelativeCutSiteDistances[[j]])[i],
      strandPolarity = FIVE_PRIME, repitition = "all_reps", filtering = "TGG_filtered",
      includedMismatches = "C>T", additionalInformation = paste0(names(NHF1NucleosomeRelativeCutSiteDistances)[j],
                                                                 "_related_strand_aligned")
    ))
  }
...
```{r figure_8A, fig.width = 10, fig.height = 5}
for (i in seq_along(NHF1NucleosomeRelativeCutSiteDistances)) {
  plotFeatureRelativeCounts(NHF1NucleosomeRelativeCutSiteDistances[[i]]$`1h`$three_prime,
                            FEATURE_RELATIVE_POSITION, MEAN_THREE_PRIME_CUT_SITE_DISTANCE,
                            plotCutSiteSignificance = FALSE,
                            countsPlotColor = "red2", mainYAxisLabel = "Mean 3' Cut Site Distance",
                            meanCutSiteDistanceTable = NHF1NucleosomeRelativeCutSiteDistances[[i]]$`1h`$five_prime,
                            cutSiteStrandPolarity = FIVE_PRIME, smoothMeanCutSiteDistance = FALSE,
                            title = "NHF1 1h C>T All Reps TGG-Filtered Strand-Aligned",
                            xAxisLabel = "Dyad-Relative Position", xlim = c(-200, 200),
                            mainYAxisMin = 7.08, mainYAxisBreaks = seq(7.1,7.8,0.1),
                            secondaryAxisBreaks = seq(19,19.8,0.2),
                            meanCutSiteDistanceMax = 19.825, meanCutSiteDistanceMin = 18.975,
                            markFirstNucleosomeBoundaries = TRUE)
}
```
```{r figure_8B}
for (i in seq_along(NHF1NucleosomeRelativeCutSiteDistances)) {
  plotFeatureRelativeCounts(NHF1NucleosomeRelativeCutSiteDistances[[i]]$`1h`$three_prime,
                            ...
                            cutSiteStrandPolarity = FIVE_PRIME, smoothMeanCutSiteDistance = FALSE,
                            title = "NHF1 1h C>T All Reps TGG-Filtered Strand-Aligned",
                            xAxisLabel = "Dyad-Relative Position", xlim = c(-100, -40),
                            mainYAxisMin = 7.08, mainYAxisBreaks = seq(7.1,7.8,0.1),
                            secondaryAxisBreaks = seq(19,19.8,0.2),
                            meanCutSiteDistanceMax = 19.825, meanCutSiteDistanceMin = 18.975)
}
...
for (i in seq_along(NHF1NucleosomeRelativeCutSiteDistances)) {
  plotFeatureRelativeCounts(NHF1NucleosomeRelativeCutSiteDistances[[i]]$`1h`$three_prime,
                            ...
                            cutSiteStrandPolarity = FIVE_PRIME, smoothMeanCutSiteDistance = FALSE,
                            title = "NHF1 1h C>T All Reps TGG-Filtered Strand-Aligned",
                            xAxisLabel = "Dyad-Relative Position", xlim = c(40, 100),
                            mainYAxisMin = 7.08, mainYAxisBreaks = seq(7.1,7.8,0.1),
                            secondaryAxisBreaks = seq(19,19.8,0.2),
                            meanCutSiteDistanceMax = 19.825, meanCutSiteDistanceMin = 18.975)
}
...
plotMismatchPositionFrequencies(NHF1CPDMismatchDataAllReps$`1h`, omittedTypes = c("C>T"),
                                title = "NHF1 CPD 1h All Reps !C>T Mismatch Pos Frequencies",
                                xAxisBreaks = c(-1,-10,-20,-30), ylim = c(0,0.05))
```


```{r figure_S2}
plotMismatchTypeFrequencies(NHF1CPDMismatchDataAllReps$`8h`, ylim = c(0,0.6),
                            title = "NHF1 CPD 8h All Reps Mismatch Type Frequencies")

plotMismatchTypeFrequencies(NHF1CPDMismatchDataAllReps$`24h`, ylim = c(0,0.5),
                            title = "NHF1 CPD 24h All Reps Mismatch Type Frequencies")

plotMismatchTypeFrequencies(NHF1CPDMismatchDataAllReps$`48h`, ylim = c(0,0.4),
                            title = "NHF1 CPD 48h All Reps Mismatch Type Frequencies")


print("NHF1 CPD81h all reps C>T mismatch dipyrimidine context frequency:")
plotTrinucleotideContext(NHF1CPDMismatchDataAllReps$`8h`, includedTypes = c("C>T"),
                         title = "NHF1 CPD 8h All Reps C>T Mismatch Trinuc Context",
                         printDipyFreq = TRUE, ylim = c(0,0.4))

print("NHF1 CPD 24h all reps C>T mismatch dipyrimidine context frequency:")
plotTrinucleotideContext(NHF1CPDMismatchDataAllReps$`24h`, includedTypes = c("C>T"),
                         title = "NHF1 CPD 24h All Reps C>T Mismatch Trinuc Context",
                         printDipyFreq = TRUE, ylim = c(0,0.25))

print("NHF1 CPD 48h all reps C>T mismatch dipyrimidine context frequency:")
plotTrinucleotideContext(NHF1CPDMismatchDataAllReps$`48h`, includedTypes = c("C>T"),
                         title = "NHF1 CPD 48h All Reps C>T Mismatch Trinuc Context",
                         printDipyFreq = TRUE)


plotMismatchPositionFrequencies(NHF1CPDMismatchDataAllReps$`8h`, includedTypes = c("C>T"),
                                title = "NHF1 CPD 8h All Reps C>T Mismatch Pos Frequencies",
                                xAxisBreaks = c(-1,-10,-20,-30), ylim = c(0,0.2))

plotMismatchPositionFrequencies(NHF1CPDMismatchDataAllReps$`24h`, includedTypes = c("C>T"),
                                title = "NHF1 CPD 24h All Reps C>T Mismatch Pos Frequencies",
                                xAxisBreaks = c(-1,-10,-20,-30))

plotMismatchPositionFrequencies(NHF1CPDMismatchDataAllReps$`48h`, includedTypes = c("C>T"),
                                title = "NHF1 CPD 48h All Reps C>T Mismatch Pos Frequencies",
                                xAxisBreaks = c(-1,-10,-20,-30), ylim = c(0,0.2))
```
...
plotTrinucleotideContext(GM12878CisplatinMismatchDataAllReps$`90min`, includedTypes = c("C>T"),
                         ...
                         printDipyFreq = TRUE, ylim = c(0,0.1))
...
```{r figure_S4}
plotMismatchTypeFrequencies(arabidopsisCPDMismatchDataAllReps$ZT2, ylim = c(0,0.8),
...
```{r figure_S5}
plotMismatchTypeFrequencies(CSBCPDMismatchDataAllReps$`1h`, ylim = c(0,0.8),
                            title = "CS-B CPD 1h All Reps Mismatch Type Frequencies")

plotMismatchTypeFrequencies(XPCCPDMismatchDataAllReps$`1h`, ylim = c(0,0.8),
...
arabidopsisCPDTGGSeqFreqAllReps = arabidopsisCPDTimepoints
for (i in seq_along(arabidopsisCPDTGGSeqFreqAllReps)) {
  arabidopsisCPDTGGSeqFreqAllReps[[i]] = fread(generateFilePath(
    directory = arabidopsisGeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
    cellType = "Arabidopsis", lesion = "CPD", repitition = "all_reps",
    timepoint = names(arabidopsisCPDTGGSeqFreqAllReps)[i], sequence = "TGG"
  ))
}

yeastCPDTGGSeqFreqAllReps = yeastCPDTimepoints
for (i in seq_along(yeastCPDTGGSeqFreqAllReps)) {
  yeastCPDTGGSeqFreqAllReps[[i]] = fread(generateFilePath(
    directory = yeastGeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
    cellType = "yeast", lesion = "CPD", repitition = "all_reps",
    timepoint = names(yeastCPDTGGSeqFreqAllReps)[i], sequence = "TGG"
  ))
}
```


```{r figure_S6, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(arabidopsisCPDTGGSeqFreqAllReps$ZT2, title = "Arabidopsis CPD ZT2 All Reps General Read TGG Freq",
                        showThreePrimeCutSite = TRUE, showFivePrimeCutSite = TRUE, querySequences = c("TGG"),
                        expansionOffset = 10, minReadLength = 22, maxReadLength = 28, positionOffset = 10,
                        yAxisLabel = "TGG Trinucleotide Frequency", defaultColor = "Black", ylimMax = 0.15)

plotSequenceFrequencies(yeastCPDTGGSeqFreqAllReps$`20min`, title = "Yeast CPD 20min All Reps General Read TGG Freq",
                        showThreePrimeCutSite = TRUE, showFivePrimeCutSite = TRUE, querySequences = c("TGG"),
                        expansionOffset = 10, minReadLength = 20, maxReadLength = 24, positionOffset = 10,
                        yAxisLabel = "TGG Trinucleotide Frequency", defaultColor = "Black", ylimMax = 0.15)
```
...
```{r figure_S7A, fig.width = 6.5, fig.height = 6}
### Just the 1h timepoint ###
...
#                                xAxisLabel = "Mismatch Relative Position")
```
```{r figure_S7B, fig.width = 6.5, fig.height = 6}
### Just the 1h timepoint ###
...
#                                xAxisLabel = "Mismatch Relative Position")
```
```{r figure_S7C, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
plotPositionAcrossTimepointAndReadLength(NHF1CPDMismatchDataAllRepsTGGFiltered["1h"], includedTypes = c("C>T"),
                                         title = "NHF1 CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
...
#                                          posType = THREE_PRIME, yAxisLabel = "Relative C>T Frequency")
```
```{r figure_S7D, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
...
CSBCPDMismatchDataAllRepsTGGFiltered = CSBCPDTimepoints
for (i in seq_along(CSBCPDMismatchDataAllRepsTGGFiltered)) {
  CSBCPDMismatchDataAllRepsTGGFiltered[[i]] = fread(generateFilePath(
    CSBSequenceAndPositionDataDirectory, dataTypeStrings$simplifiedMismatches, ".tsv",
    cellType = "CS-B", lesion = "CPD", timepoint = names(CSBCPDMismatchDataAllRepsTGGFiltered)[i],
    repitition = "all_reps", filtering = "TGG_filtered"
  ))
}
XPCCPDMismatchDataAllRepsTGGFiltered = XPCCPDTimepoints
for (i in seq_along(XPCCPDMismatchDataAllRepsTGGFiltered)) {
  XPCCPDMismatchDataAllRepsTGGFiltered[[i]] = fread(generateFilePath(
    XPCSequenceAndPositionDataDirectory, dataTypeStrings$simplifiedMismatches, ".tsv",
    cellType = "XP-C", lesion = "CPD", timepoint = names(XPCCPDMismatchDataAllRepsTGGFiltered)[i],
    repitition = "all_reps", filtering = "TGG_filtered"
  ))
}

CSBCPDMMFreqZScoresAllRepsTGGFiltered = CSBCPDTimepoints
for (i in seq_along(CSBCPDMMFreqZScoresAllRepsTGGFiltered)) {
  CSBCPDMMFreqZScoresAllRepsTGGFiltered[[i]] = fread(generateFilePath(
    CSBSequenceAndPositionDataDirectory, dataTypeStrings$mismatchFrequencyZScores, ".tsv",
    cellType = "CS-B", lesion = "CPD", repitition = "all_reps", filtering = "TGG_filtered",
    timepoint = names(CSBCPDMMFreqZScoresAllRepsTGGFiltered)[i], includedMismatches = c("C>T")
  ))
}
XPCCPDMMFreqZScoresAllRepsTGGFiltered = XPCCPDTimepoints
for (i in seq_along(XPCCPDMMFreqZScoresAllRepsTGGFiltered)) {
  XPCCPDMMFreqZScoresAllRepsTGGFiltered[[i]] = fread(generateFilePath(
    XPCSequenceAndPositionDataDirectory, dataTypeStrings$mismatchFrequencyZScores, ".tsv",
    cellType = "XP-C", lesion = "CPD", repitition = "all_reps", filtering = "TGG_filtered",
    timepoint = names(XPCCPDMMFreqZScoresAllRepsTGGFiltered)[i], includedMismatches = c("C>T")
  ))
}

CSBCPDGroupedStatsAllRepsFiltered = list(three_prime = NULL, five_prime = NULL)
for (i in seq_along(CSBCPDGroupedStatsAllRepsFiltered)) {
  CSBCPDGroupedStatsAllRepsFiltered[[i]] = fread(generateFilePath(
    CSBSequenceAndPositionDataDirectory, dataTypeStrings$mismatchPositionStats, ".tsv",
    cellType = "CS-B", lesion = "CPD", repitition = "all_reps", filtering = "TGG_filtered",
    strandPolarity = names(CSBCPDGroupedStatsAllRepsFiltered)[i]
  ))
}
XPCCPDGroupedStatsAllRepsFiltered = list(three_prime = NULL, five_prime = NULL)
for (i in seq_along(XPCCPDGroupedStatsAllRepsFiltered)) {
  XPCCPDGroupedStatsAllRepsFiltered[[i]] = fread(generateFilePath(
    XPCSequenceAndPositionDataDirectory, dataTypeStrings$mismatchPositionStats, ".tsv",
    cellType = "XP-C", lesion = "CPD", repitition = "all_reps", filtering = "TGG_filtered",
    strandPolarity = names(XPCCPDGroupedStatsAllRepsFiltered)[i]
  ))
}
```


```{r figure_S8A, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(CSBCPDMismatchDataAllRepsTGGFiltered["1h"], includedTypes = c("C>T"),
                                         title = "CSB CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = CSBCPDMMFreqZScoresAllRepsTGGFiltered,
                                         yAxisLabel = "Relative C>T Frequency", xAxisBreaks = c(-1,-10,-20,-30))
```
```{r figure_S8B, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(XPCCPDMismatchDataAllRepsTGGFiltered["1h"], includedTypes = c("C>T"),
                                         title = "CSB CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = CSBCPDMMFreqZScoresAllRepsTGGFiltered,
                                         yAxisLabel = "Relative C>T Frequency", xAxisBreaks = c(-1,-10,-20,-30))
```
```{r figure_S8C, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(CSBCPDMismatchDataAllRepsTGGFiltered["1h"], includedTypes = c("C>T"),
                                         title = "CSB CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = CSBCPDMMFreqZScoresAllRepsTGGFiltered,
                                         posType = FIVE_PRIME, yAxisLabel = "Relative C>T Frequency",
                                         xAxisBreaks = c(1,10,20,30))
```
```{r figure_S8D, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(XPCCPDMismatchDataAllRepsTGGFiltered["1h"], includedTypes = c("C>T"),
                                         title = "XPC CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = XPCCPDMMFreqZScoresAllRepsTGGFiltered,
                                         posType = FIVE_PRIME, yAxisLabel = "Relative C>T Frequency",
                                         xAxisBreaks = c(1,10,20,30))
```
```{r figure_S8E, fig.width = 7.5, fig.height = 5}
plotGroupedPositionStats(CSBCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                         CSBCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                         POS_DIFF, title = "CSB CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Diff",
                         xAxisBreaks = c(22:30), ylim = c(0,5))
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(CSBCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   CSBCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(CSBCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
...
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(CSBCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   ...
                                   mismatchData = NHF1CPDMismatchDataAllRepsTGGFiltered$`1h`)))
```
```{r figure_S8F, fig.width = 7.5, fig.height = 5}
plotGroupedPositionStats(XPCCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                         XPCCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                         POS_DIFF, title = "XPC CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Diff",
                         xAxisBreaks = c(22:30), ylim = c(0,5))
print(paste("3' endpoint variation: ",
            getThreePrimeVariation(XPCCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
                                   XPCCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "1h"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(XPCCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "1h"],
...
```{r figure_S9A, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(yeastCPDMismatchDataAllRepsFiltered["20min"], includedTypes = c("C>T"),
                                         ...
                                         yAxisLabel = "Relative C>T Frequency", xAxisBreaks = c(-1,-10,-20,-30))
```
```{r figure_S9B, fig.width = 5, fig.height = 5}
plotPositionAcrossTimepointAndReadLength(yeastCPDMismatchDataAllRepsFiltered["20min"], includedTypes = c("C>T"),
                                         title = "Yeast CPD 20min All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = yeastCPDMMFreqZScoresAllRepsFiltered,
                                         posType = FIVE_PRIME, yAxisLabel = "Relative C>T Frequency",
                                         xAxisBreaks = c(1,10,20,30))
```
```{r figure_S9C, fig.width = 7.5, fig.height = 5}
plotGroupedPositionStats(yeastCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
                         ...
                         xAxisBreaks = c(22:25), ylim = c(0,2.5))

print(paste("3' endpoint variation: ",
            getThreePrimeVariation(yeastCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
                                   yeastCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "20min"],
                                   endpointVariation = TRUE)))
print(paste("3' variation (unweighted): ",
            getThreePrimeVariation(yeastCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
...
print(paste("3' variation (weighted): ",
            getThreePrimeVariation(yeastCPDGroupedStatsAllRepsFiltered$three_prime[Timepoint == "20min"],
                                   yeastCPDGroupedStatsAllRepsFiltered$five_prime[Timepoint == "20min"],
                                   mismatchData = yeastCPDMismatchDataAllRepsFiltered$`20min`)))
```


```{r read_figure_S10_data}
...
CSBGeneralReadsCPDSeqFreqAllReps1hFilteredCombined = fread(generateFilePath(
  CSBGeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
  cellType = "CS-B", lesion = "CPD", timepoint = "1h", repitition = "all_reps",
  sequence = "HYV", filtering = "TGG_filtered", additionalInformation = "combined_read_lengths"
))
XPCGeneralReadsCPDSeqFreqAllReps1hFilteredCombined = fread(generateFilePath(
  XPCGeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
  cellType = "XP-C", lesion = "CPD", timepoint = "1h", repitition = "all_reps",
  sequence = "HYV", filtering = "TGG_filtered", additionalInformation = "combined_read_lengths"
))
```


```{r figure_S10, fig.width = 5, fig.height = 4}
...
plotSequenceFrequencies(GM12878GeneralReadsCisplatinSeqFreqRep1_90minFilteredCombined[Position <= 7],
                        ...
                        checkPositions = -1, displayPValue = FALSE, xAxisLabel = "5' Relative Position",
                        xAxisOffset = 1, ylimMax = 0.6, ylimMaxModifier = 1)
plotSequenceFrequencies(CSBGeneralReadsCPDSeqFreqAllReps1hFilteredCombined[Position <= 7],
                        title = "CSB CPD 1h All Reps TGG-Filtered General Reads HYV Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "HYV Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("333"), xAxisOffset = 1,
                        expansionOffset = 10, backgroundPositions = -9:-4,
                        checkPositions = -1, displayPValue = FALSE, xAxisLabel = "5' Relative Position",
                        xAxisBreaks = c(-8, 0, 8), ylimMax = 0.6, ylimMaxModifier = 1)
plotSequenceFrequencies(XPCGeneralReadsCPDSeqFreqAllReps1hFilteredCombined[Position <= 7],
                        title = "XPC CPD 1h All Reps TGG-Filtered General Reads HYV Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "HYV Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("333"), xAxisOffset = 1,
                        expansionOffset = 10, backgroundPositions = -9:-4,
                        checkPositions = -1, displayPValue = FALSE, xAxisLabel = "5' Relative Position",
...
```{r figure_S11, fig.width = 6.5, fig.height = 6}
...
```{r figure_S12, fig.width = 5, fig.height = 5.5}
...
```{r figure_S13, fig.width = 6, fig.height = 5}
print(paste0("8h CC>TT Read Length Slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`8h`$CC_to_TT)))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`8h`$CC_to_TT, READ_LENGTH,
                           title = "NHF1 8h CC>TT All Reps TGG-filtered",
                           xlim = c(10.5, 26.5), ylim = c(17.5, 33.5),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(18,33,3))
print(paste0("8h CC>TT Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`8h`$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`8h`$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 8h CC>TT All Reps TGG-filtered",
                           xlim = c(10.5,26.5), ylim = c(0,16),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(0,15,3))
```
...
```{r figure_S14, fig.width = 6, fig.height = 5}
print(paste0("1h C>T Read Length Slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`1h`$C_to_T)))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$C_to_T, READ_LENGTH,
                           title = "NHF1 1h C>T All Reps TGG-filtered",
                           xlim = c(10.5, 26.5), ylim = c(17.5, 33.5),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(18,33,3))
print(paste0("1h C>T Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`1h`$C_to_T)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$C_to_T, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 1h C>T All Reps TGG-filtered",
                           xlim = c(10.5,26.5), ylim = c(0,16),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(0,15,3))
print(paste0("8h C>T Read Length Slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`8h`$C_to_T)))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`8h`$C_to_T, READ_LENGTH,
                           title = "NHF1 8h C>T All Reps TGG-filtered",
                           xlim = c(10.5, 26.5), ylim = c(17.5, 33.5),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(18,33,3),
                           breaks = c(25000, 50000, 75000, 100000))
print(paste0("8h C>T Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`8h`$C_to_T)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`8h`$C_to_T, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 8h C>T All Reps TGG-filtered",
                           xlim = c(10.5,26.5), ylim = c(0,16),
                           xAxisBreaks = seq(11,26,3), yAxisBreaks = seq(0,15,3),
                           breaks = c(25000, 50000, 75000, 100000))
...
```{r read_figure_S15_data}
yeastPairedCutSiteDistances = list(`20min` = NULL)
yeastPairedCutSiteDistances$`20min` = list(CC_to_TT = NULL, non_C_to_T = NULL)
yeastPairedCutSiteDistances$`20min`$CC_to_TT = fread(generateFilePath(
  yeastCutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances, ".tsv",
  cellType = "yeast", lesion = "CPD", timepoint = "20min",
  repitition = "all_reps", filtering = "TGG_filtered",
  includedMismatches = "CC>TT"
))

arabidopsisPairedCutSiteDistances = list(ZT2 = NULL)
arabidopsisPairedCutSiteDistances$ZT2 = list(CC_to_TT = NULL, non_C_to_T = NULL)
arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT = fread(generateFilePath(
  arabidopsisCutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances , ".tsv",
  cellType = "Arabidopsis", lesion = "CPD", timepoint = "ZT2",
  repitition = "all_reps", filtering = "TGG_filtered",
  includedMismatches = "CC>TT"
))
...
```{r figure_S15, fig.width = 6, fig.height = 5}
print(paste0("Arabidopsis CC>TT read length slope: ", getReadLengthSlope(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT)))
plotPairedCutSiteDistances(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT, READ_LENGTH,
                           title = "Arabidopsis ZT2 CC>TT All Reps TGG-filtered",
                           xlim = c(15,25), ylim = c(22,32), yAxisBreaks = c(23,25,27,29,31))
print(paste0("Arabidopsis CC>TT Coupling: ", getCouplingRate(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(arabidopsisPairedCutSiteDistances$ZT2$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "Arabidopsis ZT2 CC>TT All Reps TGG-filtered",
                           xlim = c(15,25), ylim = c(3,13), yAxisBreaks = c(4,6,8,10,12))

print(paste0("Yeast CC>TT read length slope: ", getReadLengthSlope(yeastPairedCutSiteDistances$`20min`$CC_to_TT)))
plotPairedCutSiteDistances(yeastPairedCutSiteDistances$`20min`$CC_to_TT, READ_LENGTH,
                           title = "Yeast 20min CC>TT All Reps TGG-filtered",
                           xlim = c(11,19), ylim = c(19.5,27.5), yAxisBreaks = waiver())
print(paste0("Yeast CC>TT Coupling: ", getCouplingRate(yeastPairedCutSiteDistances$`20min`$CC_to_TT)*-100, '%'))
plotPairedCutSiteDistances(yeastPairedCutSiteDistances$`20min`$CC_to_TT, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "Yeast 20min CC>TT All Reps TGG-filtered",
                           xlim = c(11,20), ylim = c(5,14),
                           xAxisBreaks = c(11,13,15,17,19), yAxisBreaks = c(5,7,9,11,13))
```


```{r figure_S16A, fig.width = 10, fig.height = 5}
for (i in seq_along(NHF1NucleosomeRelativeCutSiteDistances)) {
  plotFeatureRelativeCounts(NHF1NucleosomeRelativeCutSiteDistances[[i]]$`8h`$three_prime,
                            plotCutSiteSignificance = FALSE,
                            FEATURE_RELATIVE_POSITION, MEAN_THREE_PRIME_CUT_SITE_DISTANCE,
                            countsPlotColor = "red2", mainYAxisLabel = "Mean 3' Cut Site Distance",
                            meanCutSiteDistanceTable = NHF1NucleosomeRelativeCutSiteDistances[[i]]$`8h`$five_prime,
                            cutSiteStrandPolarity = FIVE_PRIME, smoothMeanCutSiteDistance = FALSE,
                            title = "NHF1 8h C>T All Reps TGG-Filtered Strand-Aligned",
                            xAxisLabel = "Dyad-Relative Position", xlim = c(-200, 200),
                            secondaryAxisBreaks = seq(19,19.8,0.2),
                            meanCutSiteDistanceMax = 19.825, meanCutSiteDistanceMin = 18.975,
                            markFirstNucleosomeBoundaries = TRUE)
