...
plotPositionAcrossTimepointAndReadLength(arabidopsisCPDMismatchDataAllRepsFiltered["1h"], includedTypes = c("C>T"),
                                         title = "Arabidopsis CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = arabidopsisCPDMMFreqZScoresAllRepsFiltered)
plotPositionAcrossTimepointAndReadLength(yeastCPDMismatchDataAllRepsFiltered["1h"], includedTypes = c("C>T"),
                                         title = "Yeast CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
...
print(
    ggplot(NHF1TandemMismatchCountsComparisonAllReps, aes(x = Mismatch_Type, y = Tandem_Mismatches_Count)) +
      geom_bar(aes(fill = Search_Method), stat = "identity", position = "dodge") +
      labs(title = "NHF1 CPD All Reps Tandem Mismatch Counts", x = "Mismatch Type", y = "Tandem Mismatch Count") +
