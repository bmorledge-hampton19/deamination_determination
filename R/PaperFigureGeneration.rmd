...
#                                          zScoreTables = NHF1CPDMMFreqZScoresAllReps)
```
```{r figure_3B, fig.width = 6, fig.height = 5}
### Just the 1h timepoint ###
...
```{r figure_5A, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
...
#                                          zScoreTables = yeastCPDMMFreqZScoresAllRepsFiltered)
```
```{r figure_5B, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
plotPositionAcrossTimepointAndReadLength(NHF1CPDMismatchDataAllRepsFiltered["1h"], includedTypes = c("C>T"),
                                         title = "NHF1 CPD 1h All Reps TGG-Filtered C>T Mismatch Pos Freq",
                                         zScoreTables = NHF1CPDMMFreqZScoresAllRepsFiltered,
...
```{r figure_6A, fig.width = 6, fig.height = 5}
### Just the 1h timepoint ###
...
```{r figure_7B, fig.width = 8, fig.height = 5}
...
print(
    ggplot(NHF1TandemMismatchCountsComparisonAllReps, aes(Mismatch_Type, Tandem_Mismatches_Count, fill = Search_Method)) +
      ...
      geom_text(aes(label=Tandem_Mismatches_Count), position = position_dodge(width = 0.9), vjust = -0.25) +
...
```{r figure_8A, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
...
#                                          zScoreTables = NHF1CPDCCtoTTMMFreqZScoresAllRepsFiltered)
```
```{r figure_8B, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
...
```{r figure_S3, fig.width = 9, fig.height = 5}
plotNucFreqVsReadLengthBarPlot(NHF1FivePrimeMismatchCPDNucFreqAllRepsFiltered,
