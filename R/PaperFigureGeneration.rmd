...
plotSequenceFrequencies(EColiGeneralReadsCPDSeqFreqAllReps5MinFilteredCombined[Position <= 7],
...
```{r figure_S4, fig.width = 5, fig.height = 4}
...
```{r figure_S5, fig.width = 6.5, fig.height = 6}
...
```{r figure_S6, fig.width = 5, fig.height = 5.5}
