...
plotSequenceFrequencies(NHF1CPDTGGSeqFreqAllReps$`1h`, title = "NHF1 CPD 1h All Reps General Read TGG Freq",
                        ...
                        expansionOffset = 10, minReadLength = 20, maxReadLength = 27,
...
```{r figure_4A, fig.width = 5, fig.height = 6}
### Just the 1h timepoint ###
...
#                                xAxisLabel = "Mismatch Relative Position")
```
```{r figure_4B, fig.width = 5, fig.height = 5}
...
#                         endBasedCheckPositions = -10, xAxisLabel = "Mismatch Relative Position",
#                         significanceAsteriskBreakpoints = c(1e-6, 1e-9))
...
print(
    ggplot(NHF1TandemMismatchCountsComparisonAllReps, aes(Mismatch_Type, Tandem_Mismatches_Count, fill = Search_Method)) +
      ...
      blankBackground + defaultTextScaling + scale_fill_brewer(palette = "Set1") + coord_cartesian(ylim = c(0,200000))
  )
```
...
NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllRepsFiltered = NHF1CPDTimepoints
for (i in seq_along(NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllRepsFiltered)) {
  NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllRepsFiltered[[i]] = fread(generateFilePath(
    NHF1ExcisionSiteDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
    cellType = "NHF1", lesion = "CPD", repitition = "all_reps", includedMismatches = "CC>TT",
    timepoint = names(NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllRepsFiltered)[i],
    strandPolarity = "three_prime", anchored = TRUE, sequence = "YR", filtering = "TGG_filtered"
  ))
}
...
```{r figure_6A, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
...
### Just the 1h timepoint ###
plotSequenceFrequencies(NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllRepsFiltered$`1h`,
                        title = "NHF1 CPD 1h All Reps TGG-Filtered CC>TT 3' Anchored YR Freq",
                        secondaryYAxisLabel = "5' Cut Site Distance", yAxisLabel = "YR Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"),
                        expansionOffset = 10, minReadLength = 19, maxReadLength = 25, endBasedBackgroundNum = 8,
                        endBasedCheckPositions = -10, displayPValue = TRUE, xAxisLabel = "Mismatch Relative Position")
...
### All timepoints together ###
# plotSequenceFrequencies(NHF1ThreePrimeMMAnchoredCPDCCtoTTSeqFreqAllRepsFiltered,
#                         title = "NHF1 CPD All Reps TGG-Filtered CC>TT 3' Anchored YR Freq",
#                         secondaryYAxisLabel = "5' Cut Site Distance", yAxisLabel = "YR Frequency",
#                         showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"),
#                         expansionOffset = 10, minReadLength = 19, maxReadLength = 25, endBasedBackgroundNum = 8,
#                         endBasedCheckPositions = -10, displayPValue = TRUE, xAxisLabel = "Mismatch Relative Position")
...
```{r figure_S3A, fig.width = 6.5, fig.height = 6}
### Just the 1h timepoint ###
...
#                                xAxisLabel = "Mismatch Relative Position")
```
```{r figure_S3B, fig.width = 6.5, fig.height = 6}
### Just the 1h timepoint ###
...
#                                xAxisLabel = "Mismatch Relative Position")
```
```{r figure_S3D, fig.width = 5, fig.height = 5}
### Just the 1h timepoint ###
...
EColiThreePrimeMismatchCPDNucFreqAllReps = fread(generateFilePath(
  EColiExcisionSiteDataDirectory, dataTypeStrings$nucleotideFrequencyData, ".tsv",
  cellType = "E_coli_WT", lesion = "CPD", repitition = "all_reps",
  strandPolarity = "three_prime", anchored = TRUE
))
EColiThreePrimeMMAnchoredCPDSeqFreqAllReps = EColiCPDTimepoints
for (i in seq_along(EColiThreePrimeMMAnchoredCPDSeqFreqAllReps)) {
  EColiThreePrimeMMAnchoredCPDSeqFreqAllReps[[i]] = fread(generateFilePath(
    EColiExcisionSiteDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
    cellType = "E_coli_WT", lesion = "CPD", repitition = "all_reps",
    timepoint = names(EColiThreePrimeMMAnchoredCPDSeqFreqAllReps)[i],
    strandPolarity = "three_prime", anchored = TRUE, sequence = "YR"
  ))
}
```


```{r figure_S4A, fig.width = 6.5, fig.height = 6}
plotNucFreqVsReadLengthBarPlot(NHF1ThreePrimeMismatchCPDNucFreqAllRepsFiltered[Timepoint == "1h"], 
                               ...
                               xAxisLabel = "Mismatch Relative Position")
```
```{r figure_S4B, fig.width = 5, fig.height = 6}
plotNucFreqVsReadLengthBarPlot(NHF1FivePrimeMismatchCPDNucFreqAllRepsTGFiltered[Timepoint == "1h"],
                               title = "NHF1 CPD 1h ALL Reps TG-Filtered 5' Anchored Purine Freq",
                               yAxisLabel = "Purine Frequency", secondaryYAxisLabel = "3' Cut Site Distance",
                               combineNucleotides = c("AG"), combinedNames = c("Purine"),
                               posType = FIVE_PRIME, showThreePrimeCutSite = TRUE,
                               expansionOffset = 10, minReadLength = 6, maxReadLength = 13,
                               xAxisLabel = "Mismatch Relative Position")
```
```{r figure_S4C}
plotNucFreqVsReadLengthBarPlot(EColiThreePrimeMismatchCPDNucFreqAllReps,
                               title = "NHF1 E coli ALL Reps 5' Anchored Purine Freq",
                               yAxisLabel = "Purine Frequency", secondaryYAxisLabel = "5' Cut Site Distance",
                               combineNucleotides = c("AG"), combinedNames = c("Purine"),
                               posType = FIVE_PRIME, showFivePrimeCutSite = TRUE,
                               expansionOffset = 10,
...
```
```{r figure_S4D}
plotSequenceFrequencies(EColiThreePrimeMMAnchoredCPDSeqFreqAllReps,
                        title = "E coli CPD 30min All Reps 3' Anchored YR Freq",
                        secondaryYAxisLabel = "5' Cut Site Distance", yAxisLabel = "YR Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"),
                        expansionOffset = 10, xAxisLabel = "Mismatch Relative Position")
```
...
NHF1SixFour20MinSeqFreqAllRepsFiltered = fread(generateFilePath(
  NHF1GeneralReadSequenceDataDirectory, dataTypeStrings$sequenceFrequency, ".tsv",
  cellType = "NHF1", lesion = "6-4", timepoint = "20min",
  repitition = "all_reps", sequence = "YR", filtering = "TGG_filtered"
))
NHF1SixFour20MinSeqFreqAllRepsFiltered[, Position := Position + 10]
endPositionsByTimepointAndRL = NHF1SixFour20MinSeqFreqAllRepsFiltered[, .(End = max(abs(Position))),
                                                      by = Read_Length]
setkey(endPositionsByTimepointAndRL, Read_Length)
endPosByFullFreqRow = endPositionsByTimepointAndRL[list(NHF1SixFour20MinSeqFreqAllRepsFiltered$Read_Length)]$End
seqFreqPlottingRows = NHF1SixFour20MinSeqFreqAllRepsFiltered[abs(Position) + abs(17) > endPosByFullFreqRow]

GM12878Cisplatin90MinSeqFreqRep1Filtered = fread(generateFilePath(
  ...
  repitition = "rep1", sequence = "YR", filtering = "TGG_filtered"
))
GM12878Cisplatin90MinSeqFreqRep1Filtered[, Position := Position + 10]
endPositionsByTimepointAndRL = GM12878Cisplatin90MinSeqFreqRep1Filtered[, .(End = max(abs(Position))),
                                                      by = Read_Length]
setkey(endPositionsByTimepointAndRL, Read_Length)
endPosByFullFreqRow = endPositionsByTimepointAndRL[list(GM12878Cisplatin90MinSeqFreqRep1Filtered$Read_Length)]$End
seqFreqPlottingRows = GM12878Cisplatin90MinSeqFreqRep1Filtered[abs(Position) + abs(17) > endPosByFullFreqRow]
```


```{r figure_S5, fig.width = 5, fig.height = 6}
plotSequenceFrequencies(arabidopsisThreePrimeMMAnchoredCPDSeqFreqAllRepsFiltered$ZT2,
                        title = "Arabidopsis CPD All Reps TGG-Filtered 3' Anchored YR Freq",
                        secondaryYAxisLabel = "5' Cut Site Distance", yAxisLabel = "YR Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"),
                        expansionOffset = 10, minReadLength = 19, maxReadLength = 25, endBasedBackgroundNum = 8,
                        endBasedCheckPositions = 10, displayPValue = TRUE, xAxisLabel = "Mismatch Relative Position")
...
plotSequenceFrequencies(yeastThreePrimeMMAnchoredCPDSeqFreqAllRepsFiltered$`20min`,
                        title = "Yeast CPD All Reps TGG-Filtered 3' Anchored YR Freq",
                        secondaryYAxisLabel = "5' Cut Site Distance", yAxisLabel = "YR Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"),
                        expansionOffset = 10, minReadLength = 13, maxReadLength = 19, endBasedBackgroundNum = 8,
                        endBasedCheckPositions = -10, displayPValue = TRUE, xAxisLabel = "Mismatch Relative Position")

plotSequenceFrequencies(NHF1SixFour20MinSeqFreqAllRepsFiltered,
                        title = "NHF1 6-4 All Reps TGG-Filtered YR Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "YR Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"), expansionOffset = 10,
                        minReadLength = 22, maxReadLength = 30, endBasedBackgroundNum = 8,
                        endBasedCheckPositions = -10, displayPValue = TRUE, xAxisLabel = "3' Relative Position")

plotSequenceFrequencies(GM12878Cisplatin90MinSeqFreqRep1Filtered,
                        title = "GM12878 Cisplatin All Reps TGG-Filtered YR Freq",
                        secondaryYAxisLabel = "Read Length", yAxisLabel = "YR Frequency",
                        showFivePrimeCutSite = TRUE, querySequences = c("CG","CA","TG","TA"), expansionOffset = 10,
                        minReadLength = 22, maxReadLength = 30, endBasedBackgroundNum = 8,
                        endBasedCheckPositions = -10, displayPValue = TRUE, xAxisLabel = "3' Relative Position")
...
```{r figure_S6, fig.width = 9, fig.height = 5}
