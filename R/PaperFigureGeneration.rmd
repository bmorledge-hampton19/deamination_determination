...
for (i in seq_along(NHF1PairedCutSiteDistances)) {
  NHF1PairedCutSiteDistances[[i]] = list(CC_to_TT = NULL, C_to_T = NULL, non_C_to_T = NULL)
  ...
  NHF1PairedCutSiteDistances[[i]]$non_C_to_T = fread(generateFilePath(
    NHF1CutSiteCorrelationDirectory, dataTypeStrings$pairedCutSiteDistances , ".tsv",
    cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1PairedCutSiteDistances)[i],
    repitition = "all_reps", filtering = "TGG_filtered",
...
print(paste0("Read length slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`1h`$non_C_to_T)))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$non_C_to_T, READ_LENGTH,
                           title = "NHF1 1h Non-C>T All Reps TGG-filtered",
                           xlim = c(0,31), ylim = c(15,31))
```
...
print(paste0("Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`1h`$non_C_to_T)*-100, '%'))
plotPairedCutSiteDistances(NHF1PairedCutSiteDistances$`1h`$non_C_to_T, THREE_PRIME_CUT_SITE_DISTANCE,
                           title = "NHF1 1h Non-C>T All Reps TGG-filtered",
                           xlim = c(0,31), ylim = c(0,31))
```

```{r read_figure_8_data}
NHF1NucleosomeRelativeCutSiteDistances = list(`1h` = NULL, `8h` = NULL)
for (i in seq_along(NHF1NucleosomeRelativeCutSiteDistances)) {
  NHF1NucleosomeRelativeCutSiteDistances[[i]] = list(three_prime = NULL, five_prime = NULL)
  NHF1NucleosomeRelativeCutSiteDistances[[i]]$three_prime = fread(generateFilePath(
    NHF1FeatureRelativeDataDirectory, dataTypeStrings$featureRelativeMeanCutSiteDistance, ".tsv",
    cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1NucleosomeRelativeCutSiteDistances)[i],
    strandPolarity = THREE_PRIME, repitition = "all_reps", filtering = "TGG_filtered",
    includedMismatches = "C>T", additionalInformation = "hg19_mnase_all_related_strand_aligned"
  ))
  NHF1NucleosomeRelativeCutSiteDistances[[i]]$five_prime = fread(generateFilePath(
    NHF1FeatureRelativeDataDirectory, dataTypeStrings$featureRelativeMeanCutSiteDistance, ".tsv",
    cellType = "NHF1", lesion = "CPD", timepoint = names(NHF1NucleosomeRelativeCutSiteDistances)[i],
...
plotFeatureRelativeCounts(NHF1NucleosomeRelativeCutSiteDistances$`1h`$three_prime,
                          ...
                          meanCutSiteDistanceTable = NHF1NucleosomeRelativeCutSiteDistances$`1h`$five_prime,
...
print(paste0("1h non-C>T Read Length Slope: ", getReadLengthSlope(NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered)))
...
print(paste0("1h non-C>T Coupling: ", getCouplingRate(NHF1PairedCutSiteDistances$`1h`$Non_C_to_T_Position_Filtered)))
...
plotFeatureRelativeCounts(NHF1NucleosomeRelativeCutSiteDistances$`8h`$three_prime,
                          plotCutSiteSignificance = FALSE,
                          FEATURE_RELATIVE_POSITION, MEAN_THREE_PRIME_CUT_SITE_DISTANCE,
                          countsPlotColor = "red2", mainYAxisLabel = "Mean 3' Cut Site Distance",
                          meanCutSiteDistanceTable = NHF1NucleosomeRelativeCutSiteDistances$`1h`$five_prime,
