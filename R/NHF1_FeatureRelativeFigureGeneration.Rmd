...
for (CPDTimepoint in names(CPDTimepoints)) {
  for (mismatchType in names(mismatchTypes)) {
    for (tfbs in names(TFBSs)) {
      ...
      plotFeatureRelativeCounts(featureRelativePositionData, FEATURE_RELATIVE_POSITION, meanThreePrimeCutSiteDistanceData,
                                THREE_PRIME, title = paste(cellType, "CPD", CPDTimepoint, mismatchType, tfbs, "Aligned Strands"))
      
      plotFeatureRelativeCounts(featureRelativePositionData, FEATURE_RELATIVE_POSITION, meanFivePrimeCutSiteDistanceData,
                                FIVE_PRIME, title = paste(cellType, "CPD", CPDTimepoint, mismatchType, tfbs, "Aligned Strands"))
...
for (CPDTimepoint in names(CPDTimepoints)) {
  for (mismatchType in names(mismatchTypes)) {
    for (nucMap in names(nucMaps)) {
      ...
      plotFeatureRelativeCounts(featureRelativePositionData, FEATURE_RELATIVE_POSITION, meanThreePrimeCutSiteDistanceData,
                                THREE_PRIME, title = paste(cellType, "CPD", CPDTimepoint, mismatchType, nucMap, "Aligned Strands"))
      
      plotFeatureRelativeCounts(featureRelativePositionData, FEATURE_RELATIVE_POSITION, meanFivePrimeCutSiteDistanceData,
                                FIVE_PRIME, title = paste(cellType, "CPD", CPDTimepoint, mismatchType, nucMap, "Aligned Strands"))
