...
```{r setup_chunk}
library(knitr)
opts_chunk$set(dev = "png", dpi = 600, fig.width = 7, fig.height = 5, fig.path = "deamination_analysis_figures/")
if (interactive()) {
...
dir.create("deamination_analysis_tables")

fwrite(CPDGroupedStats$rep1$three_prime,
       file.path("deamination_analysis_tables", "CPD_mismatch_three_prime_position_stats_rep1.tsv"),sep = '\t')
fwrite(CPDGroupedStats$rep2$three_prime,
       file.path("deamination_analysis_tables", "CPD_mismatch_three_prime_position_stats_rep2.tsv"),sep = '\t')
fwrite(CPDGroupedStats$rep1$five_prime,
       file.path("deamination_analysis_tables", "CPD_mismatch_five_prime_position_stats_rep1.tsv"),sep = '\t')
fwrite(CPDGroupedStats$rep2$five_prime,
       file.path("deamination_analysis_tables", "CPD_mismatch_five_prime_position_stats_rep2.tsv"),sep = '\t')

fwrite(sixFourGroupedStats$rep1$three_prime,
       file.path("deamination_analysis_tables", "6-4_mismatch_three_prime_position_stats_rep1.tsv"), sep = '\t')
fwrite(sixFourGroupedStats$rep2$three_prime,
       file.path("deamination_analysis_tables", "6-4_mismatch_three_prime_position_stats_rep2.tsv"), sep = '\t')
fwrite(sixFourGroupedStats$rep1$five_prime,
       file.path("deamination_analysis_tables", "6-4_mismatch_five_prime_position_stats_rep1.tsv"), sep = '\t')
fwrite(sixFourGroupedStats$rep2$five_prime,
       file.path("deamination_analysis_tables", "6-4_mismatch_five_prime_position_stats_rep2.tsv"), sep = '\t')
```
