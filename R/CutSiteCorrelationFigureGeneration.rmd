...
cutSiteCorrelationAnalysisFigureGeneration = function(lesion, repetition, timepoint, cellType, directory,
                                                      ...
                                                      filteredAndFormattedInput = TRUE, shuffle = FALSE) {
  ...
  if (shuffle) {
    ...
    pairedCutSiteDistances[,Read_Length := Three_Prime_Cut_Site_Distance + Five_Prime_Cut_Site_Distance]
...
```{r NHF1_cut_site_correlation_figures}
